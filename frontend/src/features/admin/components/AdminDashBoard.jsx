                ...
                products.map((product)=>(
                    <Stack>
                        <Stack sx={{opacity:product.isDeleted?.7:1}}>
                            console.log(product)
                            <ProductCard key={product._id} id={product._id} title={product.title} thumbnail={product.thumbnail} brand={product.brand?.name || "No Brand"} price={product.price} isAdminCard={true}/>
                        </Stack>
